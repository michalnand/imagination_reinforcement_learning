...
class RLStatsCompute:
    ...
    def load_file(self, file_name):
        ...
        if self.load_extended:
            model_loss              = data[9]
            entropy_motivation      = data[12]
            curiosity_motivation    = data[13]

            return iteration, games, total_score, episode_score, model_loss, entropy_motivation, curiosity_motivation
