...
import models.dqn_hindsight.src.model            as Model
import models.dqn_hindsight.src.config           as Config

import BitFlippingEnv 

path = "models/dqn_hindsight/"

env = BitFlippingEnv.Make(8)
env.reset()

agent = libs_agents.AgentDQNHindsight(env, Model, Config)
