...
files.append("./models/ddpg_entropy_trajectory_imagination/run_2/result/result.log")
files.append("./models/ddpg_entropy_trajectory_imagination/run_3/result/result.log")
files.append("./models/ddpg_entropy_trajectory_imagination/run_4/result/result.log")
files.append("./models/ddpg_entropy_trajectory_imagination/run_5/result/result.log")
files.append("./models/ddpg_entropy_trajectory_imagination/run_6/result/result.log")
files.append("./models/ddpg_entropy_trajectory_imagination/run_7/result/result.log")
