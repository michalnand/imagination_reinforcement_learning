...
files = []
files.append("./models/ddpg_noisy/run_0/result/result.log")
files.append("./models/ddpg_noisy/run_1/result/result.log")
files.append("./models/ddpg_noisy/run_2/result/result.log")
files.append("./models/ddpg_noisy/run_3/result/result.log")
files.append("./models/ddpg_noisy/run_4/result/result.log")
files.append("./models/ddpg_noisy/run_5/result/result.log")
files.append("./models/ddpg_noisy/run_6/result/result.log")
files.append("./models/ddpg_noisy/run_7/result/result.log")
...
plt.plot(rl_stats_compute_ddpg.iterations, rl_stats_compute_ddpg.episode_mean, label="ddpg", color='blue')
