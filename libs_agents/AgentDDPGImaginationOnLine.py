...
class AgentDDPGImaginationOnLine():
    ...
    def main(self):
        ...
        if self.enabled_training:
            ...
            state_next_t = torch.from_numpy(state_new).to(self.model_actor.device).unsqueeze(0).float()
    ...
    def _entropy(self, state_t, epsilon):
        ...
        state_predicted_t = state_predicted_t.reshape((self.rollouts, batch_size, ) + self.state_shape)
