...
class AgentDDPGImaginationAdvanced():
    def __init__(self, env, ModelCritic, ModelActor, ModelForward, Config):
        ...
        self.model_critic           = ModelCritic.Model(self.state_shape, self.actions_count, self.rollouts)
        self.model_critic_target    = ModelCritic.Model(self.state_shape, self.actions_count, self.rollouts)
    ...
    def train_model(self):
        ...
        value_predicted = self.model_critic.forward(state_t, states_imagined_t, action_t)
        ...
        #actor loss
        loss_actor      = -self.model_critic.forward(state_t, states_imagined_t, self.model_actor.forward(state_t))
    ...
    def _imagine_states(self, state_t, epsilon):
        #fill initial state
        ...
        states_imagined_t = self.model_forward(states_initial_t, actions_t)
