import numpy
import torch
from .HindsightExperienceBuffer import *
...
class AgentDQNHindsight():
    def __init__(self, env, Model, Config):
        ...
        self.experience_replay = HindsightExperienceBuffer(config.experience_replay_size, self.state_shape, self.actions_count)
    ...
    def main(self, show_activity = False):
        ...
        if self.enabled_training:
            self.experience_replay.add(self.state, state_new, self.action, self.reward, done)
